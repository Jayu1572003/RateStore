...
const store_filter_dto_1 = require("./dto/store-filter.dto");
...
let StoresController = class StoresController {
    ...
    findAll(filterDto, user) {
        const userId = user.role === user_entity_1.UserRole.NORMAL_USER ? user.userId : null;
...
__decorate([
    ...
    __metadata("design:paramtypes", [store_filter_dto_1.StoreFilterDto, Object]),
